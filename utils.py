...
def import_train_configuration(config_file):
    ...
    config = {'gui': content['simulation'].getboolean('gui'),
              ...
              'init_bikes_per_dock': content['simulation'].getint('init_bikes_per_dock'),
              'max_bikes_per_dock': content['simulation'].getint('max_bikes_per_dock'),
              'width_layers': content['model'].getint('width_layers'),
              'training_epochs': content['model'].getint('training_epochs'),
              'reward_multiplier': content['model'].getint('reward_multiplier'),
